...
class PromptBartModel(nn.Module):
    def __init__(self, tokenizer, label_ids, args):
        ...
        self.use_prompt = args.train.use_prompt
        self.prompt_len = args.train.prompt_len
        self.prompt_dim = args.train.prompt_dim
        self.learn_weights = args.train.learn_weights
        self.device = 'cuda' if torch.cuda.is_available else 'cpu'
        bart_name = args.train.bart_name

        self.bart_config = BartConfig.from_pretrained(bart_name)
        self.bart_config.use_prompt = args.train.use_prompt
        self.bart_config.preseqlen = args.train.prompt_len
